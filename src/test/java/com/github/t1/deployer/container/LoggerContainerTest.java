...
public class LoggerContainerTest {
    ...
    public void shouldHaveOneLogger() throws Exception {
        ...
        assertIsRoot(container.logger(ROOT));

        assertIsFoo(container.logger(LoggerCategory.of("foo")));
    ...
    public void shouldFailToAddRootLogger() throws IOException {
        ...
        assertThatThrownBy(() -> container.logger(ROOT).add())
    ...
    public void shouldUpdateRootLogLevel() throws IOException {
        ...
        container.logger(ROOT).writeLevel(ERROR);
    ...
    public void shouldFailToRemoveRootLogger() throws IOException {
        ...
        assertThatThrownBy(() -> container.logger(ROOT).remove())
